...
public class PhoenixConnection implements Connection, MetaDataMutated, SQLCloseable {
    ...
    // hereeeeeeee
    public ArrayList<String> executeStatements(Reader reader, List<Object> binds,
        ...
        JSONObject dtypes = new JSONObject(); // for dtypes
                        ...
                        if (!rs.next()) {
                            ...
                            if (out != null) {
                                ...
                                for (int i = 1; i <= columnCount; i++) {
                                    ...
                                    int columnType = (int) md.getColumnType(i);
                                        
                                    String type = "";

                                    if (columnType == Types.INTEGER || columnType == Types.SMALLINT || columnType == Types.TINYINT || columnType == Types.BIGINT) {
                                        type = "int";
                                    }

                                    else if (columnType == Types.FLOAT || columnType == Types.DOUBLE || columnType == Types.DECIMAL || columnType == Types.NUMERIC) {
                                        type = "float";
                                    }
                            ...
                            do {
                                if (out != null) {
                                    ...
                                    for (int i = 1; i <= columnCount; i++) {
                                        ...
                                        // replace comma
                                        if (columnType == Types.INTEGER || columnType == Types.SMALLINT || columnType == Types.TINYINT || columnType == Types.BIGINT || columnType == Types.FLOAT || columnType == Types.DOUBLE || columnType == Types.DECIMAL || columnType == Types.NUMERIC) {
        ...
        reslist.add(res.toJSONString());
        reslist.add(dtypes.toJSONString());
